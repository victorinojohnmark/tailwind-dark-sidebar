<template>
    <div class="flex flex-col flex-grow gap-y-5 pb-4 px-6 bg-gray-900 overflow-y-auto">
        <div class="flex items-center place-content-between h-16">
            <img src="../assets/img/tailwind-logo.svg" class="h-8" alt="">
            <!-- <h1 class="text-2xl font-extrabold text-green-700">ZL-BPMS</h1> -->
            <button type="button" @click="showMobileMenu = !showMobileMenu" class="hidden max-md:block">
        ...
        <nav class="flex flex-col flex-1">
            <ul role="list" class="flex flex-col flex-1 gap-y-7 list-none m-0 p-0">
                <li>
                ...
                <li class="mt-auto">
                    <a href="#"
                        class="-mx-2 flex gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold text-gray-400 hover:bg-gray-800 hover:text-white">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                            stroke="currentColor" aria-hidden="true" class="flex-shrink-0 w-6 h-6">
                            <path stroke-linecap="round" stroke-linejoin="round"
